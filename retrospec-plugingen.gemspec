...
# Instead, edit Jeweler::Tasks in Rakefile.retrospec.erb, and run 'rake gemspec'
# -*- encoding: utf-8 -*-
...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/retrospec/plugins/v1/plugin/templates/module_files/spec/plugin_spec.rb.retrospec.erb",
    ...
    "spec/spec_helper.rb.retrospec.erb"
  ]
